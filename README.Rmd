...
__Important: This package is having 'minor issues' with CRAN acceptance due to reticulate python integration. Because of this, please use the `development version`, which is updated with the latest features:__
...
Modeltime GluonTS is part of a __growing ecosystem__ of Modeltime forecasting packages. 
