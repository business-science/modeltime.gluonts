...
#' ```{r echo = FALSE}
#' tibble::tribble(
#'     ~ "modeltime", ~ "NBEATSEstimator",
#'     "id", "NA",
#'     "freq", "freq",
#'     "prediction_length", "prediction_length",
#'     "lookback_length", "context_length (= 2*prediction_length)",
#'     "epochs", "epochs (5)",
...
#'     "loss_function", "loss_function ('MAPE')",
#'     "num_stacks", "num_stacks (30)",
#'     "num_blocks", "num_blocks (list(1))"
#' ) %>% knitr::kable()
#' ```
#'
