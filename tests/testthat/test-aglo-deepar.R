...
test_that("deep_ar: model fitting", {
    ...
    testthat::expect_s3_class(model_fit$fit, "deepar_fit_impl")
    ...
    testthat::expect_equal(model_fit$fit$models$model_1$prediction_net$cell_type %>% py_to_r(), "gru")
    testthat::expect_equal(model_fit$fit$models$model_1$prediction_net$dropout_rate %>% py_to_r(), 0.2)
    testthat::expect_equal(model_fit$fit$models$model_1$prediction_net$prediction_length %>% py_to_r(), 24)
    testthat::expect_equal(model_fit$fit$models$model_1$prediction_net$num_cells %>% py_to_r(), 20)
    testthat::expect_equal(model_fit$fit$models$model_1$prediction_net$num_layers %>% py_to_r(), 1)
